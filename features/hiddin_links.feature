...
Scenario: New project link is hidden for sign-in users
  Given I am signed is as "user@ticketee.com"
  Then I should not see the "New Project" link
  
Scenario: New project link is shown to admins
  Given I am signed is as "admin@ticketee.com"
...
Scenario: Edit project link is show to admins
  Given I am signed is as "admin@ticketee.com"
  When I follow "TextMate 2"
...
Scenario: Delete project link is show to admins
  Given I am signed is as "admin@ticketee.com"
  When I follow "TextMate 2"
