...
describe "definition loading" do
  ...
  describe "with factory_girl.rb" do
    in_directory_with_files 'factory_girl.rb'
    it_should_behave_like "finds definitions" do
      it { should load_definitions_from('factory_girl.rb') }
    end
  end

  %w(spec test).each do |dir|
    describe "with a factories file under #{dir}" do
      in_directory_with_files File.join(dir, 'factory_girl.rb')
      it_should_behave_like "finds definitions" do
        it { should load_definitions_from("#{dir}/factory_girl.rb") }
      end
    end
